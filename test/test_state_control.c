...
{ 
    char buffer[2];
    char buffer2[3]="OK";
    bg96_SendCmdSingle_ExpectAndReturn(CMD_STATUS,"OK","ERROR",buffer,100,bg96_OK);
...
{
    char buffer[2];
    bg96_SendCmdSingle_ExpectAndReturn(CMD_STATUS_USIM ,"OK","ERROR",buffer,100,bg96_OK);
    bg96_SendCmdSingle_IgnoreArg_md_Responde();
