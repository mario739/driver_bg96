...
st_config_context_tcp config_context_tcp={.context_id=1,.context_type=1,.tcp_apn="4g.entel",
                                          .tcp_username="",.tcp_password="",.method_authentication=1};
st_config_parameters_mqtt config_parameters_mqtt={.identifier_socket_mqtt=0,.quality_service=0,
                                                   .host_name="\"industrial.api.ubidots.com\"",.port=1883,
                                                   .mqtt_client_id="123456789",.mqtt_username="",.mqtt_password=""};

st_bg96_config config_module={.send_data_device=NULL
                              ,.ft_resp=FT_BG96_ERROR,.last_error=BG96_NO_ERROR,.
                              sim_comfig=&config_sim,.obj_tcp=&config_context_tcp,.obj_mqtt=&config_parameters_mqtt};
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+CMGS=\"72950576\"\r",">",12000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
//    send_data_ExpectAndReturn("HOLA\r",NULL,12000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
//    send_data_ExpectAndReturn("\x1A\r",RS_BG96_OK,12000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QICSGP=1,1,\"4g.entel\",\"\",\"\",1\r",RS_BG96_OK,300,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QIACT=1\r",RS_BG96_OK,150000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QIDEACT=1\r",RS_BG96_OK,40000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QMTCFG=\"pdpid\",0,1\r",RS_BG96_OK,300,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QMTOPEN=0,\"industrial.api.ubidots.com\",1883\r",RS_BG96_CERO,75000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QMTCLOSE=0\r",RS_BG96_CERO,300,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QMTCONN=0,\"123456789\",\"\",\"\"\r",RS_BG96_CERO,5000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
// {
//    char buffer[30]={0};
//    send_data_ExpectAndReturn("AT+QMTDISC=0\r",RS_BG96_CERO,300,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
//    send_data_ExpectAndReturn("AT+QMTPUB=0,0,0,0,\"/v1.6/devices/demo\"\r",RS_BG96_SIGNAL,300,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
//    send_data_ExpectAndReturn("{\"demo\":10,\"humedad\":60}\x1a\r",RS_BG96_CERO,15000,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
//    char topic[19]="/v1.6/devices/demo";
//    char data[25]="{\"demo\":10,\"humedad\":60}";
//    send_data_ExpectAndReturn(CMD_BG96_STATUS_MODEM,RS_BG96_OK,100,FT_BG96_OK);
//    send_data_IgnoreArg_buffer();
...
//    TEST_ASSERT_EQUAL_UINT(BG96_NO_ERROR,config_module.last_error);
// }
